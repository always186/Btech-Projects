...
const int s1=A8;//pins on which sensors have been connected
const int s2=A9;
const int s3=A10;
const int s4=A11;
...
for (int i = 0; i < 5; i++)
{
sensors_average += int(a[i] * (i+1) * 1000); //Calculating the weighted mean
...
Serial.println(" ");
delay(200); //Set the number to change frequency of readings.
}
